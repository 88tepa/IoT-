...
public class MainService {
	...
	public int join(JoinVO vo) {
		...
		// passwordEncoder.matches(password, password); : 암호 해독 함수 사용자가 입력한 비밀번호와 DB에 저장된 비밀번호 일치여부 체크
		
		return mapper.insertUsers(vo);
	}

	public boolean verifyRecaptcha(String recaptcha) {
		final String SECRET_KEY = "6Le5nIwiAAAAAN-lTkNXF2PyjtR_PryVBSJyFx6Z";
